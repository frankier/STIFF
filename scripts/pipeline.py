...
def proc_stiff(method, inf, outf, head=None, no_zstd_out=False):
    ...
    elif method == "finnpos-no-pos-first-precision":
        pipeline = (
            pipeline
            | python[filter_py, "fold-support", "fi", "-", "-"]
            | python[filter_py, "lang", "fi", "-", "-"]
    ...
    elif method == "finnpos-no-pos-soft-first-precision":
        pipeline = (
            pipeline
            | python[filter_py, "fold-support", "fi", "-", "-"]
            | python[filter_py, "lang", "fi", "-", "-"]
    ...
    elif method == "finnpos-no-pos-soft-deriv-first-precision":
        pipeline = (
            pipeline
            | python[filter_py, "fold-support", "fi", "-", "-"]
            | python[filter_py, "lang", "fi", "-", "-"]
            ...
            | python[filter_py, "has-support-dom", "--proc=dom", "-", "-"]
            | python[filter_py, "align-dom", "--proc=dom", "-", "-"]
            | python[filter_py, "non-deriv-dom", "--proc=dom", "-", "-"]
            | python[filter_py, "rm-ambg", "-", "-"]
        )
    elif method == "finnpos-no-pos-soft-supported-freq-first-precision":
        pipeline = (
            pipeline
            | python[filter_py, "fold-support", "fi", "-", "-"]
            | python[filter_py, "lang", "fi", "-", "-"]
            ...
            | python[filter_py, "has-support-dom", "--proc=dom", "-", "-"]
            | python[filter_py, "align-dom", "--proc=dom", "-", "-"]
            | python[filter_py, "supported-freq-dom", "-", "-"]
            | python[filter_py, "rm-ambg", "-", "-"]
        )
